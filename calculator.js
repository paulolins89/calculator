...
calculator = (e) => {
    ...
    //adjusts what's on the screen depend on how big the number is
        ...
        if (parseFloat(screen.textContent) > 99999999 || parseFloat(screen.textContent) < 0){
            screen.textContent = parseFloat(screen.textContent).toExponential(3);
        }else if ((parseFloat(screen.textContent) <= 99999999) && (parseFloat(screen.textContent) > 0)){
            screen.textContent = Number(parseFloat(screen.textContent).toFixed(3));
        }
